...
export function SwipeableJobCard({ onClose, articles }: SwipeableJobCardProps) {
  ...
  return (
    <>
              ...
              <div className="p-3 space-y-3">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <span className="text-sm">{formatTime(currentArticle.start_time)} - {formatTime(currentArticle.end_time)}</span>
                  </div>
                </div>
      ...
      {showPopup && <AnalysisPopup onClose={() => { setShowPopup(false); onClose(); }} />}
    </>
  )
}
